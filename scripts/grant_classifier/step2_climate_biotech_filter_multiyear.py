...
# PATHS - CONFIGURATION
# =========================
# This script runs AFTER merge_master_multiyear.py
...
# Input file (from merge_master_multiyear.py output)
INFILE = OUTPUT_DIR / "merged_all_years.csv"

# Output files
OUT_KEPT = OUTPUT_DIR / "climate_biotech_filtered_all_years.csv"
OUT_EXCL = OUTPUT_DIR / "climate_biotech_excluded_all_years.csv"
...
def main():
    ...
    if len(insufficient_abstract) > 0:
        # NEW:
        insufficient_path = OUTPUT_DIR / "climate_biotech_insufficient_abstract_all_years.csv"
